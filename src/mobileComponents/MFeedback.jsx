  ...
  return (
    <>
      ...
      <Box className="flex flex-col justify-center items-center bg-[white] bg-cover w-[100vw]">
        ...
        <a aria-label="Veja Nos" target='_blank' className='my-6 font-bold rounded-3xl bg-[#fbb336] text-white px-6 py-2' href="https://maps.app.goo.gl/7BFVjHe37rvrv75y5">Veja Nos</a>
      </Box>
    </>
  );
};
