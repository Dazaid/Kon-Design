    ...
    <>
      ...
      <Box className="text-white flex flex-col gap-7 justify-center text-center items-center text-2xl w-[100vw] konradialgradient3 py-16">
        ...
        <Box className="flex flex-row gap-6">
          <a target="_blank" href="https://www.instagram.com/kon_design_/"><Box className="bg-white h-12 w-12 rounded-full flex justify-center items-center">
          ...
          <a target="_blank" href="https://www.facebook.com/kondesignpt"><Box className="bg-white h-12 w-12 rounded-full flex justify-center items-center">
          ...
          <a target="_blank" href="https://wa.me/351913916397"><Box className="bg-white h-12 w-12 rounded-full flex justify-center items-center">
      ...
      <Box ref={servicosRef} className="flex flex-col gap-5 justify-center items-start pl-8 pb-6 w-[100vw] bg-[#0b0009] text-white">
        <Box className="flex flex-col justify-center items-start">
          <TrendingFlatIcon aria-label="TrendingFlatIcon" sx={{ fontSize: 50, color: '#ffc000' }} className='relative top-5 right-2' />
          <h2 className='text-4xl'>
            <b>
              BRANDING
            </b>
          </h2>
          <Box className="mb-2 bg-gradient-to-r from-[#090310] from-10% via-[#6d2f95] via-50% to-[#fbba07] to-90% w-[12.5rem] h-[0.65vh] mt-2"></Box>
        ...
        <Box className="flex flex-col justify-center items-start">
          <TrendingFlatIcon aria-label="TrendingFlatIcon2" sx={{ fontSize: 50, color: '#fff' }} className='relative top-5 right-2' />
          <h2 className='text-4xl'>
            <b>
              PRINTING
            </b>
          </h2>
          <Box className="mb-2 bg-gradient-to-r from-[#090310] from-10% via-[#6d2f95] via-50% to-[#fbba07] to-90% w-[11.3rem] h-[0.65vh] mt-2"></Box>
          <h3 className='text-xl'>
            EXPOSITOR <br />
            LOGOTIPO <br />
            GRANDES FORMATOS
