    ...
    <>
      <Box ref={portfolioRef} className="flex justify-center items-center bg-[#0b0009] w-[100vw] py-16">
        <Box className="flex flex-col gap-16 justify-center items-center w-[100vw]">
          ...
          <a target="_blank" aria-name="whatsapp" href="https://wa.me/351913916397"><button className='hover:scale-105 transition-all duration-300 text-[#0b0009] bg-white py-3 px-5 rounded-lg font-bold'>SOLICITAR ORÇAMENTO</button></a>
        </Box>
      </Box>
      ...
      <Box className="text-white flex flex-row gap-20 justify-center text-start items-center h-[16vh] w-[100vw] bg-gradient-to-r from-[#e1a901] from-0% via-[#020202] via-50% to-[#200b39] to-100%">
        ...
        <Box className="flex flex-row gap-14">
          <a target="_blank" aria-name="instagram" href="https://www.instagram.com/kon_design_/"><Box className="bg-white h-12 w-12 rounded-full flex justify-center items-center">
          ...
          <a target="_blank" aria-name="facebook" href="https://www.facebook.com/kondesignpt"><Box className="bg-white h-12 w-12 rounded-full flex justify-center items-center">
          ...
          <a target="_blank" aria-name="whatsapp" href="https://wa.me/351913916397"><Box className="bg-white h-12 w-12 rounded-full flex justify-center items-center">
      ...
      <Box ref={servicosRef} className="flex flex-row gap-20 justify-center items-center pb-6 h-[22vh] w-[100vw] bg-[#0b0009] text-white">
        <Box className="flex flex-col justify-center items-start">
          ...
          <Box class="mb-2 bg-gradient-to-r from-[#090310] from-10% via-[#6d2f95] via-50% to-[#fbba07] to-90% w-[7.5vw] h-[0.65vh] mt-2"></Box>
