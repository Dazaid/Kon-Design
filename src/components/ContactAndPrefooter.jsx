...
const ContactAndPrefooter = () => {
  return (
    <>
      <Box className="konradialgradient2 flex flex-row gap-20 justify-center items-center py-6 pb-16 h-[30vh] w-[100vw] bg-[#0b0009] text-white">
        <Box className="flex flex-col justify-center items-start">
          ...
          <Box class="mb-2 bg-gradient-to-r from-[#090310] from-10% via-[#6d2f95] via-50% to-[#fbba07] to-90% w-60 h-[0.65vh] mt-2"></Box>
      ...
      <Box className="flex flex-row justify-center items-center bg-black">
        <Box className="flex flex-col items-center bg-black text-white p-6 w-[60vw]">
          <Box className="flex flex-col items-start w-[600px]">
            <Box>
              <h2 className="text-6xl font-bold mb-4">CONTATO</h2>
              <Box class="mb-2 bg-gradient-to-r from-[#090310] from-10% via-[#6d2f95] via-50% to-[#fbba07] to-90% w-[25rem] h-[0.65vh] mt-2"></Box>
            </Box>
            <Box component="p" className="text-left text-xl mb-6 mt-6">
              Dúvidas? Não deixe de perguntar.
              <br />
              Nos mande sua dúvida, elogio, sugestões <br />
              ou reclamações, vamos adorar estar recebendo <br /> sua mensagem.
            </Box>
          </Box>
          <Box component="form" className="w-full max-w-[600px] space-y-4">
            ...
            />
            <Box component="button" className="w-full flex justify-end">
              <button
                type="reset"
                className="px-8 font-bold p-2 bg-black text-white rounded-full border border-white hover:bg-[#fbba07] transition-colors"
              >
                Enviar
              </button>
            </Box>
        ...
        <Box className="flex flex-col gap-10 items-start bg-black text-white p-6 w-[40vw]">
          <a
          ...
          >
            <svg
              className="relative top-[1px] fill-white hover:fill-[#fbba07] transition-colors w-5 h-5"
              xmlns="http://www.w3.org/2000/svg"
              viewBox="0 0 512 512"
            >
              <path d="M164.9 24.6c-7.7-18.6-28-28.5-47.4-23.2l-88 24C12.1 30.2 0 46 0 64C0 311.4 200.6 512 448 512c18 0 33.8-12.1 38.6-29.5l24-88c5.3-19.4-4.6-39.7-23.2-47.4l-96-40c-16.3-6.8-35.2-2.1-46.3 11.6L304.7 368C234.3 334.7 177.3 277.7 144 207.3L193.3 167c13.7-11.2 18.4-30 11.6-46.3l-40-96z" />
            </svg>
            <p className="text-2xl text-[#fbba07] font-bold hover:text-[#fff] transition-colors">
              +351 223 701 446
            </p>
          </a>
          <a
          ...
          >
            ...
            <p className="text-xl text-[#fbba07] font-bold hover:text-[#fff] transition-colors">
...
export default ContactAndPrefooter;
