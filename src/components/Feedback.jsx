  ...
  return (
    <>
      ...
      <Box className="flex flex-col justify-center items-center bg-[white] bg-cover h-[90vh] w-[100vw]">
        ...
        <a target='_blank' aria-name="feedback" href="https://g.co/kgs/igCc3C"><button className='relative bottom-16 left-96 font-bold rounded-3xl bg-[#fbb336] text-white px-6 py-2'>Veja mais</button></a>
      </Box>
    </>
  );
};
