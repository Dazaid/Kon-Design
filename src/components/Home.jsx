    ...
    <>
      ...
      <img className='absolute w-[96vw] h-[100vh]  object-cover z-[-1]' src="/assets/HomeBkg.png" title='background design' alt="background design" />
        ...
        <Box className="flex flex-row text-white h-[51vh] gap-24">
          <Box className="flex flex-col gap-24">
            ...
            <Box className="flex flex-col gap-4">
              <a target="_blank" href="https://wa.me/351913916397">
                <button
                  className="flex font-bold bg-gradient-to-r from-[#7bf309] from-10% via-[#3f9306] via-50% to-[#083b03] to-90% text-white rounded-lg py-2 px-14 hover:scale-105 transition-all duration-300">
          ...
          <button onClick={() => scrollToSection(homeRef)}><p className="hover:text-[#ffbb00] hover:cursor-pointer transition-all duration-100">Home</p></button>
          <button onClick={() => scrollToSection(contactRef)}><p className="hover:text-[#ffbb00] hover:cursor-pointer transition-all duration-100">Sobre Nós</p></button>
          <button onClick={() => scrollToSection(servicosRef)}><p className="hover:text-[#ffbb00] hover:cursor-pointer transition-all duration-100">Serviços</p></button>
